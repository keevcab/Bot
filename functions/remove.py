...
categories = [
    "aura", "bag", "blush", "body", "dress", "earrings", "emote", "eye",
    "eyebrow", "fishing_rod", "freckle", "fullsuit", "glasses", "gloves",
    "hair_back", "hair_front", "handbag", "hat", "jacket", "lashes", "mole",
    "mouth", "necklace", "nose", "rod", "shirt", "shoes", "shorts", "skirt",
    "sock", "tattoo", "watch", "makeup"
]
...
async def remove(self: BaseBot, user: User, message: str):
    ...
    if len(parts) != 2:
        await self.highrise.chat(
            "Invalid command format. You need to specify the category.")
        return
